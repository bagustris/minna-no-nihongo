...
|------------|---------|----------|
| 飼います | かいます | keep (a pet), raise (an animal) |
| 建てます | たてます | build |
| 走ります | はしります | run, drive |
| 道を走ります | みちをはしります | run, drive along a road |
| 取ります | とります | take |
| 休みを取ります | やすみをとります | take a holiday |
...
| 教室を開きます | きょうしつをひらきます | set up a class |
| ペット | ペット | pet |
| 鳥 | とり | bird |
| 声 | こえ | voice |
| 波 | なみ | wave |
