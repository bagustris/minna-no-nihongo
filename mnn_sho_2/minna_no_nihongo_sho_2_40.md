...
| 測ります | はかります | measure |
| 量ります | はかります | weigh |
| 確かめます | たしかめます | confirm, make sure |
| 合います | あいます | fit |
| サイズが合います | サイズがあいます | the size fits |
| 出発します | しゅっぱつします | depart |
...
| 高さ | たかさ | height |
| 大きさ | おおきさ | size, scale |
| ～便 | ～びん | flight, flight number |
| ～号 | ～ごう | train number, typhoon number |
| ～個 | ～こ | (counter for small objects) |
| ～本 | ～ほん | (counter for long objects) |
| ～杯 | ～はい | glass or cup (counter for full cups, glasses) |
| ～キロ | ～キロ | kilograms, kilometers |
| ～グラム | ～グラム | grams |
| ～センチ | ～センチ | centimeters |
| ～ミリ | ～ミリ | millimeters |
