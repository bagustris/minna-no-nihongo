...
|------------|---------|----------|
| 育てます | そだてます | breed, bring up |
| 運びます | はこびます | carry, transport |
| 亡くなります | なくなります | pass away (euphemistic expression for shinimasu) |
| 入院します | にゅういんします | enter hospital |
| 入れます | いれます | turn on |
| 電源を入れます | でんげんをいれます | turn on the power switch |
| 切ります | きります | turn off |
| 電源を切ります | でんげんをきります | turn off the power switch |
| 掛けます | かけます | lock |
...
| 整理します | せいりします | put (things) in order, tidy up |
...
| 似ています | にています | resemble, be like |
| 性格 | せいかく | character |
| おとなしい | おとなしい | quiet |
| 世話をします | せわをします | take care |
| 時間がたちます | じかんがたちます | time pass by |
